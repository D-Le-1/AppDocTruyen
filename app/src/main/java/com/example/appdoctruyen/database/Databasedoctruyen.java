...
public class Databasedoctruyen extends SQLiteOpenHelper {
    ...
    private String SQLQuery3 = "INSERT INTO TaiKhoan VAlUES (null,'datle','datle','datle@gmail.com',1)";
    ...
    public void AddTaiKhoan(TaiKhoan taiKhoan){
        ...
        //Thuc hien insert thong qua ContentValues
    ...
    public void Themtruyen(Truyen truyen){
        ...
        values.put(IMAGE, truyen.getImg());
